			...
			<div className={s.user}>
				<div className={s.userTop}>
						...
						<div className={s.userInfo}>
							...
							<p><span>University:</span> Dnipro University of technology</p>
							<p><span>Graduation:</span> 2025</p>
						</div>
				</div>
					<div className={s.addInfo}>
						<p><span>Email address:</span> test@gmail.com</p>
						<p><span>Birthday:</span> 10.10.2005</p>
					</div>
			</div>
		</>
	)
